...
#define SOFTMACQ_FC_BEIB1 \
  (SOFTMACQ_BEIB1_FREQ - NT1035_VCO1_FREQ) /** IF of Beidou B1 */
#define SOFTMACQ_FC_BEIB2 \
  (SOFTMACQ_BEIB2_FREQ - NT1035_VCO2_FREQ) /** IF of Beidou B2 -high side */
